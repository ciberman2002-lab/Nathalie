...
//     desc: "Soluções ágeis e preventivas via cartórios, mediação e conciliação. Agilidade na regularização de bens e contratos sem a necessidade de morosos processos judiciais.",
...
//   return (
//     <section id="expertise" className="py-24 md:py-32 px-6 relative overflow-hidden">
//       <div className="max-w-7xl mx-auto">
//         <div className="text-center mb-16 md:mb-24">
//           <span className="text-[10px] tracking-[0.5em] gold-text uppercase block mb-4 font-classic">Serviços Exclusivos</span>
//           <h2 className="font-serif-luxury text-3xl md:text-5xl bordeaux-text mb-6">Expertise que Transmite Confiança</h2>
...
//             >
//               {/* Background Number - Large and Elegant */}
...
//               {/* Icon Container with underline like the image */}
...
//               {/* Subtle hover line effect to add premium feel without text link */}
//               <div className="w-0 h-[1px] bg-gold opacity-30 group-hover:w-full transition-all duration-1000 mt-8" />
//             </motion.div>
//           ))}
//         </div>
//       </div>
...
//   {
//     title: "Advocacia Extrajudicial",
//     desc: "Soluções ágeis e preventivas via cartórios, mediação e conciliação. Agilidade na regularização de bens e direitos sem as delongas do sistema judiciário tradicional.",
//     icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
//     id: "03",
//   },
// ];
...
//             Especialidades
//           </span>
//           <h2 className="font-serif-luxury text-4xl md:text-5xl bordeaux-text italic">
//             Áreas de Atuação
//           </h2>
//         </div>
...
//               className="group relative p-8 lg:p-12 border border-slate-50 hover:border-[#c5a028]/20 transition-all duration-700 hover:bg-[#fdfbf7]"
//             >
//               <div className="text-[70px] md:text-[90px] font-classic bordeaux-text opacity-[0.04] absolute top-6 right-10 group-hover:opacity-[0.08] transition-all duration-700 select-none pointer-events-none">
//                 {item.id}
//               </div>
...
//               <h3 className="font-classic text-sm bordeaux-text mb-8 tracking-[0.2em] uppercase text-center lg:text-left">
//                 {item.title}
//               </h3>

//               <p className="text-[13px] text-slate-500 leading-relaxed font-light text-center lg:text-left">
//                 {item.desc}
//               </p>
//             </motion.div>
//           ))}
