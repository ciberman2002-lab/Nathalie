...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Desde a Reforma Trabalhista, o acordo extrajudicial pode ser submetido à homologação da Justiça do Trabalho. Após a homologação judicial, o acordo passa a produzir efeitos nos termos estabelecidos pelas partes e dentro dos limites previstos na legislação vigente.",
  },
  {
