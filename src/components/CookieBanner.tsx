...
const CookieBanner: React.FC = () => {
  ...
  // Função para comunicar decisão ao Google Tag Manager / Analytics
  ...
  useEffect(() => {
    ...
    if (!savedConsent) {
      // Se não há decisão, mostra o banner após 2 segundos
      setTimeout(() => setShowBanner(true), 2000);
    } else {
      // Se já existe decisão, aplica as configurações ao carregar
  ...
  const handleAcceptAll = () => {
    const allIn = { necessary: true, analytics: true, functional: true };
    saveAndClose(allIn);
  };
    ...
    <>
      <AnimatePresence>
        {showBanner && !showModal && (
          ...
          >
            <div className="mb-6 md:mb-0 md:mr-8 text-left">
              <h4 className="font-classic text-[10px] tracking-[0.2em] uppercase bordeaux-text mb-2">
                Transparência & Privacidade
              </h4>
              <p className="text-[10px] text-slate-500 leading-relaxed max-w-2xl">
                Em conformidade com a LGPD e o Provimento 205/2021 da CFOAB,
                utilizamos cookies para garantir a funcionalidade técnica e
                analisar o tráfego de forma anônima. Sua privacidade é tratada
                com o rigor do sigilo profissional.
              </p>
            </div>
            <div className="flex flex-wrap justify-center gap-2 md:gap-4 w-full md:w-auto">
              <button
          ...
          <div className="fixed inset-0 z-200 flex items-center justify-center p-4 md:p-6 bg-black/40 backdrop-blur-sm">
            ...
            >
              <div className="p-8 md:p-12">
                <div className="flex justify-between items-start mb-10">
                  <div>
                    <span className="text-[9px] tracking-[0.4em] gold-text uppercase block mb-2 font-classic">
                      Gestão de Consentimento
                    </span>
                    <h2 className="font-serif-luxury text-3xl bordeaux-text">
                      Preferências de Cookies
                    </h2>
                  </div>
                  <button
                    onClick={() => setShowModal(false)}
                    className="bordeaux-text opacity-40 hover:opacity-100 transition-opacity"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="none"
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="pr-6">
                      <h3 className="font-classic text-[11px] tracking-widest uppercase bordeaux-text mb-1">
                        Cookies Necessários
                      </h3>
                      <p className="text-[10px] text-slate-400 leading-relaxed">
                        Essenciais para o funcionamento seguro e técnico do
                        site.
                      </p>
                    </div>
                    <div className="h-5 w-10 bg-slate-200 rounded-full relative flex items-center px-1">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="pr-6">
                      ...
                      <p className="text-[10px] text-slate-400 leading-relaxed">
                        Inclui Google Analytics. Permite medir o tráfego de
                        forma anônima.
                      </p>
                    </div>
                    <button
                  ...
                  <div className="flex items-start justify-between">
                    <div className="pr-6">
                      ...
                      <p className="text-[10px] text-slate-400 leading-relaxed">
                        Utilizados para lembrar suas preferências de navegação.
                      </p>
                    </div>
                    <button
                      onClick={() =>
